...
define config.name = _("project 03")
...
define gui.about = _p("создал: Михайленко Кирилл, группа: 231, вк айди: 417963197")
...
define build.name = "как сказать <<нет>>"
...
define config.save_directory = "project03-1758104134"
